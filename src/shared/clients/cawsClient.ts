...
export const cawsEndpoint = 'https://public.api-gamma.quokka.codes' // gamma web: https://integ.stage.quokka.codes/
export const cawsEndpointGql = 'https://public.api-gamma.quokka.codes/graphql'
export const cawsHostname = 'integ.stage.quokka.codes' // 'nqw1rfzyye.execute-api.us-east-1.amazonaws.cominteg.codedemo.dev-tools.aws.dev'
// export const cawsGitHostname = `git.service.${cawsHostname}` // prod endpoint
export const cawsGitHostname = 'git.gamma.source.caws.dev-tools.aws.dev' // gamma
