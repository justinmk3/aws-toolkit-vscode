...
const STATUS_TOOLTIP = localize('AWS.caws.statusbar.tooltip', 'Click to connect to quokka.codes or check its status.')
...
function setCawsStatusbar(statusBarItem: vscode.StatusBarItem, username?: string): void {
    statusBarItem.text = localize('AWS.caws.statusbar.text', 'quokka.codes: {0}', username || '-')
}
